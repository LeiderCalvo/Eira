export default [
    {
        title: "Concientiza el uso de energía",
        advices: [
            "Evita el derroche energético en todos los ámbitos.",
            " Adquiere aparatos electrónicos teniendo en cuenta criterios de eficiencia energética."
        ]
    },
    {
    ...
    },
    {
        ...
        advices: [
            "Prioriza productos y servicios con certificaciones ecológicas.",
            "Favorece los productos locales frente a los que requieren transporte internacional.",
            "Evita artículos que contengan productos tóxicos ."
        ]
    }
]